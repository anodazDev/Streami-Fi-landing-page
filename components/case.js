...
export default function Case() {
    return (
        <>
            <div className={`${Styles.overlay} ${' bg-gradient-to-br from-primary-300 to-supplement-500'}`}>
                <div className={`${Styles.layout_L} ${' flex  flex-wrap '}`}>
                    ...
                    <div className={`${'  items-center justify-center relative z-[2] '} ${' hidden sm:flex sm:w-4/12 xl:w-6/12'}`}>
                        <img
                            className={`${'img-fluid w-full object-bottom absolute bottom-0'}`}
                            src='../media/img/Case/Headphone.png'
                        />
                    </div>
                    <div className={`${'  mt-14 flex flex-wrap p-2'} ${'w-full sm:w-8/12 xl:w-6/12'}`}>
                        <div className={`${'flex flex-wrap   p-2'} ${'w-full sm:w-1/2'}`}>
                            <div className={`${'w-full border-2 border-white rounded-xl p-4'}`}>
